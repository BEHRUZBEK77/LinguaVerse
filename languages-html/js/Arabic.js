...
const UD_DATA = {
    beginner: [
        {
            id: 'ab0', emoji: '<i class="fa-solid fa-font" style="color:#60a5fa"></i>', title: 'الحروف الهجائية', desc: "Arab alifbosini o'rganish (28 harf)",
            level: 'beginner',
        ...
        {
            id: 'ab1', emoji: '<i class="fa-solid fa-hand" style="color:#f5c842"></i>', title: 'التحيات', desc: "Salomlashish va xayrlashish",
            level: 'beginner',
        ...
        {
            id: 'ab2', emoji: '<i class="fa-solid fa-hashtag" style="color:#60a5fa"></i>', title: 'الأرقام', desc: "Raqamlar 1-100",
            level: 'beginner',
        ...
        {
            id: 'ab3', emoji: '<i class="fa-solid fa-palette" style="color:#a78bfa"></i>', title: 'الألوان', desc: "Arabcha ranglar",
            level: 'beginner',
        ...
        {
            id: 'ab4', emoji: '<i class="fa-solid fa-people-roof" style="color:#60a5fa"></i>', title: 'العائلة', desc: "Oila a'zolari",
            level: 'beginner',
        ...
        {
            id: 'ab5', emoji: '<i class="fa-solid fa-apple-whole" style="color:#f87171"></i>', title: 'الطعام والشراب', desc: "Ovqat va ichimliklar",
            level: 'beginner',
    ...
    elementary: [
        {
            id: 'ae1', emoji: '<i class="fa-solid fa-house-chimney" style="color:#5b7cfa"></i>', title: 'المنزل والغرف', desc: "Uy va xonalar",
            level: 'elementary',
        ...
        {
            id: 'ae2', emoji: '<i class="fa-solid fa-briefcase" style="color:#94a3b8"></i>', title: 'المهن', desc: "Kasblar",
            level: 'elementary',
        ...
        {
            id: 'ae3', emoji: '<i class="fa-solid fa-cart-shopping" style="color:#5b7cfa"></i>', title: 'التسوق', desc: "Xarid qilish",
            level: 'elementary',
    ...
    'pre-intermediate': [
        {
            id: 'ap1', emoji: '<i class="fa-solid fa-hat-wizard" style="color:#a78bfa"></i>', title: 'خطط المستقبل', desc: "Kelajak va rejalar",
        ...
        {
            id: 'ap2', emoji: '<i class="fa-solid fa-bullseye" style="color:#f87171"></i>', title: 'الفعل الماضي', desc: "O'tgan zamon",
            level: 'pre-intermediate',
    ...
    advanced: [
        {
            id: 'aa1', emoji: '<i class="fa-solid fa-pen" style="color:#60a5fa"></i>', title: 'الكتابة الأكاديمية', desc: "Akademik yozuv",
            level: 'advanced',
        ...
        {
            id: 'aa2', emoji: '<i class="fa-solid fa-clipboard-list" style="color:#94a3b8"></i>', title: 'العربية التجارية', desc: "Biznes arabchasi",
            level: 'advanced',
        ...
        users.forEach((u, i) => {
            ...
            html += `<div class="lb-row${isMe ? ' me' : ''}" style="display:flex;align-items:center;gap:12px;padding:10px 14px;border-radius:14px;background:${isMe ? 'rgba(91,124,250,0.1)' : 'rgba(255,255,255,0.03)'};border:1px solid ${isMe ? 'rgba(91,124,250,0.28)' : 'rgba(255,255,255,0.06)'};margin-bottom:8px;transition:all 0.2s">
                ...
                <div style="flex:1;min-width:0">
                    <div style="font-family:'Exo 2',sans-serif;font-weight:700;font-size:0.86rem;color:#e8ecff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${esc(u.displayName || u.email || 'Foydalanuvchi')}${isMe ? ' <span style="color:#a78bfa;font-size:0.7rem">(siz)</span>' : ''}</div>
    ...
    content.innerHTML = `
      ...
      <div>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px">
          ${unit.words.map(w => `<span onclick="window.spk('${w.replace(/'/g, "\\'")}',event)" style="background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.25);color:#e8b438;padding:4px 10px;border-radius:20px;font-size:0.76rem;cursor:pointer;direction:rtl">${w} <i class='fa-solid fa-volume-high' style='color:#5b7cfa'></i></span>`).join('')}
        </div>
      </div>`;
    modal.classList.add('active');
...
function lessonA(unit) {
    ...
    const fills = words.slice(0, 4).map((w, i) => {
        ...
        return `<div style="margin-bottom:14px;padding:14px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
          ...
          <div style="display:flex;gap:6px">
            ...
            <button onclick="window.aiExWord('${w.replace(/'/g, "\\'")}',event)" style="padding:6px 14px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.25);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class='fa-solid fa-robot' style='color:#a78bfa'></i> AI</button>
    ...
    <div style="margin-bottom:20px;padding:16px;background:rgba(232,180,56,0.06);border:1px solid rgba(232,180,56,0.15);border-radius:12px">
      ...
      <div style="font-size:0.9rem;color:#e8b438;margin-bottom:8px"><i class="fa-solid fa-lightbulb" style="color:#f5c842"></i> ${unit.grammar_rule || ''}</div>
    ...
    <button onclick="window.finLessonA('${unit.id}')" style="width:100%;padding:14px;border-radius:12px;background:linear-gradient(135deg,#e8b438,#f5c842);border:none;color:#000;font-size:0.95rem;font-weight:700;cursor:pointer;font-family:inherit"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> Grammatika darsini yakunlash</button>`;
}
...
window.chkFill = function (i) {
    ...
    if (inp.value.trim() === inp.dataset.ans) {
        ...
        fb.innerHTML = `<span style="color:#ef4444"><i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> To'g'ri javob: <strong dir="rtl">${inp.dataset.ans}</strong></span>`;
...
function lessonB(unit) {
    ...
    <div style="margin-bottom:20px;padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px">
        ...
        <button onclick="window.playDict('${unit.id}','slow')" style="padding:8px 16px;border-radius:8px;background:rgba(96,165,250,0.1);border:1px solid rgba(96,165,250,0.2);color:#60a5fa;cursor:pointer;font-size:0.82rem;font-family:inherit"><i class="fa-solid fa-gauge-simple" style="color:#94a3b8"></i> Sekin</button>
      </div>
      ...
      <div style="display:flex;gap:6px;margin-top:8px">
        ...
        <button onclick="window.aiChkDict()" style="padding:7px 14px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.25);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-robot" style="color:#a78bfa"></i> AI tahlil (1 token)</button>
      </div>
      <div id="dictFB" style="margin-top:8px;font-size:0.8rem"></div>
    </div>
    <button onclick="window.finLessonB('${unit.id}')" style="width:100%;padding:14px;border-radius:12px;background:linear-gradient(135deg,#22d3ee,#e8b438);border:none;color:#000;font-size:0.95rem;font-weight:700;cursor:pointer;font-family:inherit"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> Listening yakunlash</button>`;
}
...
function renderLex(exs, idx) {
    ...
    return `<div style="padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px">
        ...
        <button onclick="window.playLex(${idx},'slow')" style="padding:8px 16px;border-radius:8px;background:rgba(96,165,250,0.1);border:1px solid rgba(96,165,250,0.2);color:#60a5fa;cursor:pointer;font-size:0.82rem;font-family:inherit"><i class="fa-solid fa-gauge-simple" style="color:#94a3b8"></i> Sekin</button>
      </div>
      ...
      <div style="display:flex;gap:6px">
        ...
        ${idx + 1 < exs.length ? `<button onclick="window.nextLex(${idx + 1})" id="lexnxt${idx}" style="display:none;padding:7px 14px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.2);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-arrow-right"></i> Keyingi</button>` : ''}
      </div>
    ...
    <div style="margin-bottom:20px">
      ...
      <div style="padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
        ...
        <div style="display:flex;gap:6px;margin-top:12px">
          <button onclick="window.rdAloud()" style="padding:7px 14px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.2);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-volume-high" style="color:#5b7cfa"></i> Tinglash</button>
        </div>
      </div>
    </div>
    <div style="margin-bottom:20px">
    ...
    <div style="margin-bottom:20px">
      ...
      ${wh.map((w, i) => {
        ...
        return `<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
          ...
          <button onclick="window.spk('${w.replace(/'/g, "\\'")}',event)" style="padding:7px 12px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.2);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class='fa-solid fa-volume-high' style='color:#5b7cfa'></i></button>
          <span id="whfb${i}" style="font-size:0.8rem;min-width:30px"></span>
        </div>`;
    }).join('')}
    </div>
    <button onclick="window.finLessonC('${unit.id}')" style="width:100%;padding:14px;border-radius:12px;background:linear-gradient(135deg,#34d399,#22d3ee);border:none;color:#000;font-size:0.95rem;font-weight:700;cursor:pointer;font-family:inherit"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> Reading yakunlash</button>`;
}
...
function lessonD(unit) {
      ...
      ${topics.map((w, i) => {
        ...
        return `<div style="margin-bottom:14px;padding:14px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
          ...
          <div style="display:flex;gap:6px;margin-bottom:8px">
            ...
            <button onclick="window.spk('${w.replace(/'/g, "\\'")}',event)" style="padding:8px 12px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.2);color:#e8b438;cursor:pointer;font-size:0.82rem;font-family:inherit"><i class='fa-solid fa-volume-high' style='color:#5b7cfa'></i></button>
          </div>
          ...
          <div style="display:flex;gap:6px;margin-top:8px">
            <button onclick="window.aiSpk(${i},'${w.replace(/'/g, "\\'")}')" style="padding:6px 14px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.25);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class='fa-solid fa-robot' style='color:#a78bfa'></i> AI baholash (1 token)</button>
    ...
    <div style="margin-bottom:20px">
      ...
      <div style="padding:14px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
        ...
        <div style="display:flex;gap:6px">
          <button onclick="window.aiWrit('${unit.title.replace(/'/g, "\\'")}','${unit.words.slice(0, 5).join(",")}')" style="padding:7px 14px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.25);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-robot" style="color:#a78bfa"></i> AI (1 token)</button>
    ...
    <div style="margin-bottom:20px">
      ...
      <div style="display:flex;gap:6px">
        ...
        <button onclick="window.spk('${woSent.replace(/'/g, "\\'")}',event)" style="padding:7px 14px;border-radius:8px;background:rgba(232,180,56,0.1);border:1px solid rgba(232,180,56,0.2);color:#e8b438;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-volume-high" style="color:#5b7cfa"></i></button>
      </div>
      <div id="wofb" style="margin-top:8px;font-size:0.8rem"></div>
    </div>
    <button onclick="window.finLessonD('${unit.id}')" style="width:100%;padding:14px;border-radius:12px;background:linear-gradient(135deg,#f472b6,#e8b438);border:none;color:#000;font-size:0.95rem;font-weight:700;cursor:pointer;font-family:inherit"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> Speaking & Writing yakunlash</button>`;
}
...
window.chkWO = function () {
    ...
    } else { if (fb) fb.innerHTML = `<span style="color:#ef4444"><i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> To'g'ri: <em dir="rtl">${window.__woCorrect}</em></span>`; }
    lTotal++;
};
window.togMic = function (idx) {
    ...
    rec.onerror = e => { if (btn) btn.innerHTML = '<i class="fa-solid fa-microphone" style="color:#f87171"></i> Gapirish'; lessonMics[idx] = null; };
...
function renderWords(reset = true) {
    ...
    slice.slice(wOff).forEach(w => {
        ...
        card.innerHTML = `<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:4px">
          <button onclick="window.spk('${w.a.replace(/'/g, "\\'")}',event)" style="background:none;border:none;cursor:pointer;font-size:1rem"><i class='fa-solid fa-volume-high' style='color:#5b7cfa'></i></button>
...
function openWModal(w) {
    ...
    c.innerHTML = `<div style="text-align:center;padding:20px">
      ...
      <div style="display:flex;gap:8px;justify-content:center">
        <button onclick="window.spk('${w.a.replace(/'/g, "\\'")}',event)" style="padding:8px 20px;border-radius:10px;background:rgba(232,180,56,0.15);border:1px solid rgba(232,180,56,0.3);color:#e8b438;cursor:pointer;font-family:inherit"><i class='fa-solid fa-volume-high' style='color:#5b7cfa'></i> Talaffuz</button>
        <button onclick="window.aiExWord('${w.a.replace(/'/g, "\\'")}',event)" style="padding:8px 20px;border-radius:10px;background:rgba(167,139,250,0.1);border:1px solid rgba(167,139,250,0.25);color:#a78bfa;cursor:pointer;font-family:inherit"><i class='fa-solid fa-robot' style='color:#a78bfa'></i> AI (1 token)</button>
      </div>
...
window.checkQuizOpt = function (btn, chosen, type) {
    ...
    else { if (fb) fb.innerHTML = `<span style="color:#ef4444"><i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> To'g'ri: <span dir="rtl">${curQuizWord.a}</span> = ${curQuizWord.u}</span>`; }
...
window.checkTyping = function () {
    ...
    if (val === w.a) {
        ...
        if (fb) fb.innerHTML = `<span style="color:#ef4444"><i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> To'g'ri: <span dir="rtl">${w.a}</span></span>`;
...
window.checkGrammar = function (chosen, ans, exp) {
    ...
    if (chosen === ans) {
        ...
        if (fb) fb.innerHTML = `<div style="color:#ef4444;padding:10px;border-radius:10px;background:rgba(239,68,68,0.1)"><i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> To'g'ri javob: <span dir="rtl"><b>${ans}</b></span>. ${exp}</div>`;
    }
};
...
window.clearChatHistory = async function () {
    ...
    if (c) c.innerHTML = `<div class="chat-msg ai-msg"><div class="chat-avatar"><i class="fa-solid fa-robot"></i></div><div class="chat-bubble">مرحباً! Chat tarixi tozalandi. Yangi suhbatni boshlaylik! <i class="fa-solid fa-face-smile" style="color:#f5c842"></i></div></div>`;
