...
const RANKS = {
    ...
    silver: { name: "Silber", icon: "<i class='fa-solid fa-medal' style='color:#C0C0C0'></i>", color: "#C0C0C0", token_bonus: 200, xp_mult: 1.3, coin_mult: 1.2 },
    ...
    diamond: { name: "Diamant", icon: "<i class='fa-solid fa-gem' style='color:#00D4FF'></i>", color: "#B9F2FF", token_bonus: 1000, xp_mult: 2.5, coin_mult: 2 },
};
...
const UD_DATA = {
    beginner: [
        {
            id: 'b0', emoji: '<i class="fa-solid fa-font" style="color:#60a5fa"></i>', title: 'Das Alphabet', desc: "Nemis alifbosini o'rganish", level: 'A1',
        ...
        {
            id: 'b1', emoji: '<i class="fa-solid fa-hand" style="color:#f5c842"></i>', title: 'Begrüßungen', desc: "Salomlashish va xayrlashish", level: 'A1',
        ...
        {
            id: 'b2', emoji: '<i class="fa-solid fa-hashtag" style="color:#60a5fa"></i>', title: 'Zahlen', desc: "Raqamlar va hisoblash", level: 'A1',
        ...
        {
            id: 'b3', emoji: '<i class="fa-solid fa-palette" style="color:#a78bfa"></i>', title: 'Farben', desc: "Nemis tilida ranglar", level: 'A1',
        ...
        {
            id: 'b4', emoji: '<i class="fa-solid fa-people-roof" style="color:#60a5fa"></i>', title: 'Die Familie', desc: "Oila a'zolari", level: 'A1',
        ...
        {
            id: 'b5', emoji: '<i class="fa-solid fa-apple-whole" style="color:#f87171"></i>', title: 'Essen und Trinken', desc: "Ovqat va ichimliklar", level: 'A1',
        ...
        {
            id: 'b6', emoji: '<i class="fa-solid fa-house" style="color:#5b7cfa"></i>', title: 'Das Zuhause', desc: "Uy va xonalar", level: 'A1',
        ...
        {
            id: 'b7', emoji: '<i class="fa-solid fa-cloud-sun" style="color:#fbbf24"></i>', title: 'Das Wetter', desc: "Ob-havo", level: 'A1',
        ...
        {
            id: 'b8', emoji: '<i class="fa-solid fa-paw" style="color:#fb923c"></i>', title: 'Tiere', desc: "Hayvonlar", level: 'A1',
        ...
        {
            id: 'b9', emoji: '<i class="fa-solid fa-map" style="color:#94a3b8"></i>', title: 'Ortsangaben', desc: "Yo'l so'rash", level: 'A1',
        ...
        {
            id: 'b10', emoji: '<i class="fa-solid fa-sack-dollar" style="color:#f5c842"></i>', title: 'Einkaufen', desc: "Do'konda xarid qilish", level: 'A1',
        ...
        {
            id: 'b11', emoji: '<i class="fa-solid fa-calendar-days" style="color:#60a5fa"></i>', title: 'Tagesablauf', desc: "Kundalik kun tartib", level: 'A1',
        ...
        {
            id: 'b12', emoji: '<i class="fa-solid fa-person" style="color:#94a3b8"></i>', title: 'Personenbeschreibung', desc: "Odamni tasvirlash", level: 'A1',
    ...
    elementary: [
        {
            id: 'e0', emoji: '<i class="fa-solid fa-house-chimney" style="color:#5b7cfa"></i>', title: 'Wohnen', desc: "Uy va xonalar", level: 'A2',
        ...
        {
            id: 'e1', emoji: '<i class="fa-solid fa-briefcase" style="color:#94a3b8"></i>', title: 'Berufe', desc: "Kasblar", level: 'A2',
        ...
        {
            id: 'e2', emoji: '<i class="fa-solid fa-cart-shopping" style="color:#5b7cfa"></i>', title: 'Einkaufen', desc: "Xarid qilish", level: 'A2',
        ...
        {
            id: 'e3', emoji: '<i class="fa-solid fa-train" style="color:#94a3b8"></i>', title: 'Reisen', desc: "Sayohat", level: 'A2',
        ...
        {
            id: 'e4', emoji: '<i class="fa-solid fa-utensils" style="color:#94a3b8"></i>', title: 'Im Restaurant', desc: "Restoranda", level: 'A2',
        ...
        {
            id: 'e5', emoji: '<i class="fa-solid fa-hospital" style="color:#f87171"></i>', title: 'Beim Arzt', desc: "Shifokorda", level: 'A2',
        ...
        {
            id: 'e6', emoji: '<i class="fa-solid fa-phone" style="color:#34d399"></i>', title: 'Kommunikation', desc: "Telefon va muloqot", level: 'A2',
        ...
        {
            id: 'e7', emoji: '<i class="fa-solid fa-gamepad" style="color:#a78bfa"></i>', title: 'Hobbys und Freizeit', desc: "Hobbylar va dam olish", level: 'A2',
        ...
        {
            id: 'e8', emoji: '<i class="fa-solid fa-school" style="color:#60a5fa"></i>', title: 'Schule und Studium', desc: "Maktab va ta'lim", level: 'A2',
        ...
        {
            id: 'e9', emoji: '<i class="fa-solid fa-earth-europe" style="color:#34d399"></i>', title: 'Geografie', desc: "Geografiya", level: 'A2',
        ...
        {
            id: 'e10', emoji: '<i class="fa-solid fa-user-tie" style="color:#94a3b8"></i>', title: 'Kleidung und Mode', desc: "Kiyim va moda", level: 'A2',
        ...
        {
            id: 'e11', emoji: '<i class="fa-solid fa-tree" style="color:#34d399"></i>', title: 'Feste und Feiertage', desc: "Bayramlar", level: 'A2',
        ...
        {
            id: 'e12', emoji: '<i class="fa-solid fa-dumbbell" style="color:#34d399"></i>', title: 'Gesundheit und Sport', desc: "Salomatlik va sport", level: 'A2',
    ...
    intermediate: [
        {
            id: 'i0', emoji: '<i class="fa-solid fa-hat-wizard" style="color:#a78bfa"></i>', title: 'Zukunftspläne', desc: "Kelajak zamonlari", level: 'B1',
        ...
        {
            id: 'i1', emoji: '<i class="fa-solid fa-bullseye" style="color:#f87171"></i>', title: 'Perfekt', desc: "Perfekt zaman", level: 'B1',
        ...
        {
            id: 'i2', emoji: '<i class="fa-solid fa-comment-dots" style="color:#5b7cfa"></i>', title: 'Kommunikation im Beruf', desc: "Ishda muloqot", level: 'B1',
        ...
        {
            id: 'i3', emoji: '<i class="fa-solid fa-seedling" style="color:#34d399"></i>', title: 'Umwelt und Natur', desc: "Atrof-muhit", level: 'B1',
        ...
        {
            id: 'i4', emoji: '<i class="fa-solid fa-laptop-code" style="color:#94a3b8"></i>', title: 'Digitale Welt', desc: "Digital dunyo", level: 'B1',
        ...
        {
            id: 'i5', emoji: '<i class="fa-solid fa-landmark" style="color:#94a3b8"></i>', title: 'Geschichte Deutschlands', desc: "Germaniya tarixi", level: 'B1',
    ...
    upperintermediate: [
        {
            id: 'u0', emoji: '<i class="fa-solid fa-pen" style="color:#60a5fa"></i>', title: 'Wissenschaftliches Schreiben', desc: "Ilmiy yozuv", level: 'B2',
        ...
        {
            id: 'u1', emoji: '<i class="fa-solid fa-scale-balanced" style="color:#94a3b8"></i>', title: 'Recht und Gesetz', desc: "Huquq va qonun", level: 'B2',
            words: ['mildern', 'die Perspektive', 'einsetzen', 'erleichtern', 'anerkennen', 'kohärent', 'erheblich', 'umstritten', 'überzeugend', 'beispiellos'],
            xp: 200, coin: 90,
            grammar_rule: "Nominalisierung: entscheiden <i class='fa-solid fa-arrow-right'></i> die Entscheidung, entwickeln <i class='fa-solid fa-arrow-right'></i> die Entwicklung",
        ...
        {
            id: 'u2', emoji: '<i class="fa-solid fa-chart-pie" style="color:#60a5fa"></i>', title: 'Wirtschaft und Finanzen', desc: "Iqtisodiyot va moliya", level: 'B2',
    ...
    advanced: [
        {
            id: 'a0', emoji: '<i class="fa-solid fa-pen-to-square" style="color:#60a5fa"></i>', title: 'Akademisches Schreiben', desc: "Akademik yozuv", level: 'C1-C2',
        ...
        {
            id: 'a1', emoji: '<i class="fa-solid fa-graduation-cap" style="color:#a78bfa"></i>', title: 'Goethe-Prüfung Vorbereitung', desc: "Goethe imtihoniga tayyorlik", level: 'C1-C2',
...
// ══════════════════════════════════════════════════════════════
const GRAMMAR_QS = [
    { q: "Sie ___ jeden Tag in die Schule.", opts: ["gehen", "geht", "gehst", "gehe"], ans: "geht", exp: "3. Person Singular <i class='fa-solid fa-arrow-right'></i> geht" },
    { q: "Ich ___ schon fünf Jahre in Berlin.", opts: ["wohne", "wohnt", "wohnst", "wohnen"], ans: "wohne", exp: "1. Person Singular <i class='fa-solid fa-arrow-right'></i> wohne" },
    { q: "Der Hund ___ sehr schnell.", opts: ["läufst", "läuft", "laufen", "laufe"], ans: "läuft", exp: "Er/Sie/Es <i class='fa-solid fa-arrow-right'></i> läuft (Umlaut!)" },
    { q: "Wir ___ gestern ins Kino gegangen.", opts: ["haben", "sein", "sind", "hatten"], ans: "sind", exp: "Bewegungsverb gehen <i class='fa-solid fa-arrow-right'></i> Perfekt mit 'sein'" },
    { q: "Das ist ___ Buch meines Vaters.", opts: ["der", "die", "das", "den"], ans: "das", exp: "Buch = Neutrum <i class='fa-solid fa-arrow-right'></i> das Buch" },
    { q: "Ich kaufe ___ neuen Computer.", opts: ["ein", "eine", "einen", "einem"], ans: "einen", exp: "Computer = Maskulinum, Akkusativ <i class='fa-solid fa-arrow-right'></i> einen" },
    { q: "Er kommt ___ Deutschland.", opts: ["von", "aus", "in", "nach"], ans: "aus", exp: "Herkunft <i class='fa-solid fa-arrow-right'></i> aus + Land (ohne Artikel)" },
    { q: "Das Buch ___ von Goethe geschrieben.", opts: ["hat", "haben", "wurde", "werden"], ans: "wurde", exp: "Vorgangspassiv Präteritum <i class='fa-solid fa-arrow-right'></i> wurde + Partizip II" },
    { q: "Er ist ___ groß als sein Bruder.", opts: ["mehr", "größer", "am größten", "so"], ans: "größer", exp: "Komparativ <i class='fa-solid fa-arrow-right'></i> größer (Umlaut!)" },
    { q: "Wenn ich Zeit ___, gehe ich spazieren.", opts: ["hätte", "habe", "hat", "haben"], ans: "habe", exp: "Realer Konditionalsatz <i class='fa-solid fa-arrow-right'></i> Indikativ Präsens: habe" },
    { q: "___ dem Regen spielten wir Fußball.", opts: ["Trotzdem", "Trotz", "Wegen", "Dank"], ans: "Trotz", exp: "Trotz + Genitiv: Trotz des Regens" },
    { q: "Sie hat das Buch ___.", opts: ["gelesen", "lesen", "las", "liest"], ans: "gelesen", exp: "Perfekt <i class='fa-solid fa-arrow-right'></i> hat + Partizip II (gelesen)" },
    { q: "Das ist ___ interessanteste Buch.", opts: ["der", "die", "das", "den"], ans: "das", exp: "Superlativ mit Neutrum: das interessanteste" },
    { q: "Ich ___ nach Berlin fahren.", opts: ["muss", "musst", "müssen", "müsst"], ans: "muss", exp: "Modalverb müssen, 1. Person Singular <i class='fa-solid fa-arrow-right'></i> muss" },
    { q: "Er hat mir ___ Buch gegeben.", opts: ["ein", "eine", "einen", "dem"], ans: "ein", exp: "Dativobjekt + Akkusativobjekt <i class='fa-solid fa-arrow-right'></i> ein Buch (Akk.)" },
];
...
function renderTokenBar() {
    ...
    if (aiInfo) {
      ...
      <div style="font-size:.72rem;color:#3d5a78;margin-bottom:4px"><i class="fa-solid fa-ticket" style="color:#a78bfa"></i> Token: <strong style="color:${color}">${UP === 'ultimate' ? '∞' : UTokens}</strong>/${UP === 'ultimate' ? '∞' : UMaxTokens}</div>
...
function showTokenEmptyModal(reason) {
    ...
    if (textEl) textEl.innerHTML = `<i class="fa-solid fa-ticket" style="color:#a78bfa"></i> Tokenlar tugadi!<br><span style="font-size:.8rem;color:#3d5a78">${reason || 'Davom etish uchun token kerak'}</span>`;
    if (timerEl) {
...
function updateDisplays() {
    ...
    if (navUInfo) navUInfo.innerHTML = `
        <div style="display:flex;align-items:center;gap:8px">
            ...
            <span style="font-size:.78rem;color:#e8c56a"><i class="fa-solid fa-star" style="color:#f5c842"></i> ${UXP.toLocaleString()}</span>
            <span style="font-size:.78rem;color:#fbbf24"><i class="fa-solid fa-coins" style="color:#f5c842"></i> ${UCoin.toLocaleString()}</span>
        </div>`;
...
window.loadLBSection = async function (field, btn) {
    ...
    try {
        ...
        users.forEach((u, i) => {
            ...
            const val = u[field] || 0;
            const init = esc((u.displayName || u.email || 'U').charAt(0)).toUpperCase();
            html += `<div class="lb-row${isMe ? ' me' : ''}">
                <div class="lb-rank">${rankIcon}</div>
                <div class="lb-avatar">${init}</div>
                <div class="lb-name">${esc(u.displayName || u.email || 'Foydalanuvchi')}${isMe ? ' <span style="color:var(--accent);font-size:.72rem">(siz)</span>' : ''}</div>
...
async function callAI(prompt, maxTok = 1000) {
    ...
    } catch (e) { return '<i class="fa-solid fa-exclamation" style="color:#fbbf24"></i> KI bilan bog\'lanishda xatolik.'; }
}
    ...
    units.forEach((unit, i) => {
      ...
      <div class="unit-card-body">
        ...
        <div style="display:flex;gap:10px;font-size:.65rem;font-family:var(--font-head);font-weight:700">
          ...
          <span style="color:var(--amber)">+${unit.coin} <i class="fa-solid fa-coins" style="color:#f5c842"></i></span>
          ${isComp ? '<span style="color:var(--green)"><i class="fa-solid fa-circle-check" style="color:#34d399"></i></span>' : ''}
        </div>
      </div>`;
...
window.openUnit = function (unit) {
    ...
    const lnames = { A: "<i class='fa-solid fa-book-open' style='color:#a78bfa'></i> Grammatik & Wortschatz", B: "<i class='fa-solid fa-headphones' style='color:#5b7cfa'></i> Hören", C: "<i class='fa-solid fa-book-open' style='color:#a78bfa'></i> Lesen", D: "<i class='fa-solid fa-microphone' style='color:#f87171'></i> Sprechen & Schreiben" };
    ...
    <div style="text-align:center;padding-bottom:20px">
      ...
      <div style="display:flex;gap:16px;justify-content:center;margin:16px 0;flex-wrap:wrap">
        <span style="color:var(--gold)"><i class="fa-solid fa-star" style="color:#f5c842"></i> +${unit.xp} XP</span>
        <span style="color:var(--amber)"><i class="fa-solid fa-coins" style="color:#f5c842"></i> +${unit.coin} Coin</span>
        <span style="color:var(--steel)"><i class="fa-solid fa-book-open-reader" style="color:#a78bfa"></i> ${unit.words.length} Wörter</span>
        <span style="color:var(--accent)"><i class="fa-solid fa-ticket" style="color:#a78bfa"></i> 2 Token/Dars</span>
      </div>
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:20px">
      ${['A', 'B', 'C', 'D'].map(k => {
        ...
        return `<div onclick="window.openLesson('${unit.id}','${k}')" style="padding:16px;border-radius:12px;background:${done ? 'rgba(46,194,126,.06)' : 'rgba(212,168,67,.04)'};border:1px solid ${done ? 'rgba(46,194,126,.25)' : 'rgba(212,168,67,.1)'};cursor:pointer;transition:all .2s;text-align:center">
          ...
          ${done ? `<div style="font-size:.72rem;color:var(--green);margin-top:4px"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> ${sc}%</div>` : '<div style="font-size:.72rem;color:var(--text3);margin-top:4px">▶ Boshlash</div>'}
        </div>`;
    }).join('')}
    </div>
    <div>
      <div style="font-size:.78rem;color:var(--text3);margin-bottom:8px"><i class="fa-solid fa-pen-to-square" style="color:#60a5fa"></i> Wörter:</div>
      <div style="display:flex;flex-wrap:wrap;gap:6px">
        ${unit.words.map(w => `<span onclick="window.spk('${w.replace(/'/g, "\\'")}',event)"
          ...
          onmouseout="this.style.background='rgba(212,168,67,.08)'">${w} <i class="fa-solid fa-volume-high" style="color:#5b7cfa"></i></span>`).join('')}
      </div>
    </div>`;
    modal.classList.add('active');
};
...
window.openLesson = async function (unitId, lessonKey) {
    ...
    const lessonTitles = {
        A: '<i class="fa-solid fa-book-open" style="color:#a78bfa"></i> Grammatik & Wortschatz',
        B: '<i class="fa-solid fa-headphones" style="color:#5b7cfa"></i> Hören & Verstehen',
        C: '<i class="fa-solid fa-book-open" style="color:#a78bfa"></i> Lesen & Verstehen',
        D: '<i class="fa-solid fa-microphone" style="color:#f87171"></i> Sprechen & Schreiben'
    };

    content.innerHTML = `
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:20px">
      <button onclick="window.openUnit(curUnit)" style="background:rgba(212,168,67,.1);border:1px solid rgba(212,168,67,.2);color:var(--accent);padding:6px 14px;border-radius:8px;cursor:pointer;font-size:.8rem"><i class="fa-solid fa-arrow-left"></i> Ortga</button>
      <div>
...
function renderLessonA(unit, body) {
    ...
    <div style="background:rgba(212,168,67,.06);border:1px solid rgba(212,168,67,.15);border-radius:12px;padding:16px;margin-bottom:20px">
      <div style="font-size:.72rem;color:var(--accent);font-weight:800;text-transform:uppercase;margin-bottom:8px"><i class="fa-solid fa-ruler-combined" style="color:#94a3b8"></i> Grammatik Qoidasi</div>
    ...
    <div style="font-size:.8rem;color:var(--text3);margin-bottom:12px"><i class="fa-solid fa-font" style="color:#60a5fa"></i> So'z boyligi — har bir so'zni o'rganing:</div>
      ...
      <div id="lexCard_${i}" style="background:rgba(255,255,255,.02);border:1px solid rgba(212,168,67,.1);border-radius:10px;padding:12px;display:flex;align-items:center;gap:12px;transition:all .3s">
        <div style="flex:1">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:3px">
            ...
            <span onclick="window.spk('${w.de.replace(/'/g, "\\'")}',event)" style="cursor:pointer;color:var(--accent);font-size:.8rem"><i class="fa-solid fa-volume-high" style="color:#5b7cfa"></i></span>
    ...
    html += `</div>
    <div style="font-size:.8rem;color:var(--text3);margin-bottom:12px"><i class="fa-solid fa-puzzle-piece" style="color:#a78bfa"></i> Grammatik mashqlari:</div>
...
function renderLessonB(unit, body) {
    ...
    <div style="margin-bottom:20px">
      <div style="font-size:.82rem;color:var(--text2);margin-bottom:8px;line-height:1.5">
        <i class="fa-solid fa-headphones" style="color:#5b7cfa"></i> Nemischa so'zlarni tinglang va o'zbek tarjimasini toping.
      </div>
    </div>
    ...
    deWords.forEach(w => {
        ...
        btn.dataset.de = w;
        btn.innerHTML = `<span onclick="window.spk('${w.replace(/'/g, "\\'")}',event);event.stopPropagation()" style="margin-right:4px;font-size:.8rem"><i class="fa-solid fa-volume-high" style="color:#5b7cfa"></i></span>${w}`;
...
function renderLessonC(unit, body) {
    ...
    <div style="background:rgba(56,189,248,.05);border:1px solid rgba(56,189,248,.15);border-radius:12px;padding:16px;margin-bottom:20px;line-height:1.7;font-size:.87rem;color:var(--text2)">
      <div style="font-size:.7rem;color:#38bdf8;font-weight:800;text-transform:uppercase;margin-bottom:10px"><i class="fa-solid fa-book-open" style="color:#a78bfa"></i> Matn</div>
      ${unit.reading_text}
    </div>
...
function renderLessonD(unit, body) {
    ...
    <div style="font-size:.82rem;color:var(--text2);margin-bottom:16px;line-height:1.5">
      <i class="fa-solid fa-pen-nib" style="color:#60a5fa"></i> Quyidagi so'zlarni nemischa yozing.
    </div>
    ...
    <button id="checkWriteBtn" onclick="window.checkWriting()" style="margin-top:20px;width:100%;padding:12px;background:linear-gradient(135deg,var(--accent),var(--gold));border:none;color:#0a0e1a;font-weight:800;border-radius:10px;cursor:pointer;font-size:.9rem;font-family:var(--font-head)">
      <i class="fa-solid fa-circle-check" style="color:#34d399"></i> Tekshirish
    </button>`;
...
async function finishLesson(key, skill) {
    ...
    <div style="text-align:center;padding:30px 10px">
      <div style="font-size:3.5rem;margin-bottom:16px">${passed ? '<i class="fa-solid fa-champagne-glasses" style="color:#f5c842"></i>' : '<i class="fa-solid fa-dumbbell" style="color:#34d399"></i>'}</div>
      ...
      ${allDone ? '<div style="background:rgba(212,168,67,.1);border:1px solid rgba(212,168,67,.3);border-radius:10px;padding:10px;margin-bottom:16px;font-size:.82rem;color:var(--gold)"><i class="fa-solid fa-trophy" style="color:#f5c842"></i> Bu unit to\'liq yakunlandi!</div>' : ''}
      <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
        ${!passed ? `<button onclick="window.openLesson('${curUnit.id}','${key}')" style="padding:10px 20px;background:rgba(212,168,67,.1);border:1px solid rgba(212,168,67,.25);color:var(--accent);border-radius:8px;cursor:pointer;font-weight:700;font-family:var(--font-head)"><i class="fa-solid fa-rotate" style="color:#5b7cfa"></i> Qayta</button>` : ''}
        <button onclick="window.openUnit(curUnit)" style="padding:10px 20px;background:linear-gradient(135deg,var(--accent),var(--gold));border:none;color:#0a0e1a;border-radius:8px;cursor:pointer;font-weight:800;font-family:var(--font-head)"><i class="fa-solid fa-arrow-left"></i> Unit ga qaytish</button>
      </div>
    </div>`;
...
function renderDictPage(words) {
    ...
    <div class="dict-card" onclick="window.showWordDetail('${w.de.replace(/'/g, "\\'")}')">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px">
        <div style="display:flex;align-items:center;gap:6px">
          ...
          <span onclick="window.spk('${w.de.replace(/'/g, "\\'")}',event)" style="font-size:.8rem;cursor:pointer;color:var(--accent)"><i class="fa-solid fa-volume-high" style="color:#5b7cfa"></i></span>
        </div>
    ...
    if (pagDiv) {
      ...
      <div style="display:flex;gap:10px;justify-content:center;align-items:center;margin-top:16px">
        ${hasPrev ? `<button onclick="wOff-=40;applyDictFilter()" style="padding:6px 16px;background:rgba(212,168,67,.1);border:1px solid rgba(212,168,67,.2);color:var(--accent);border-radius:8px;cursor:pointer;font-size:.8rem;font-family:var(--font-head)"><i class="fa-solid fa-arrow-left"></i> Oldingi</button>` : ''}
        <span style="font-size:.75rem;color:var(--text3)">${wOff + 1}–${Math.min(wOff + 40, total)} / ${total}</span>
        ${hasMore ? `<button onclick="wOff+=40;applyDictFilter()" style="padding:6px 16px;background:rgba(212,168,67,.1);border:1px solid rgba(212,168,67,.2);color:var(--accent);border-radius:8px;cursor:pointer;font-size:.8rem;font-family:var(--font-head)">Keyingi <i class="fa-solid fa-arrow-right"></i></button>` : ''}
      </div>`;
    }
}
...
window.logOut = async function () {
    try {
        ...
        await signOut(_auth);
        showToast('Chiqildi <i class="fa-solid fa-check" style="color:#34d399"></i>', 'info');
