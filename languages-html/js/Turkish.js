...
const RANKS = {
    none:    { name: "Oddiy",   icon: "<i class='fa-solid fa-square' style='color:#888'></i>", color: "#888",    token_bonus: 0,    xp_mult: 1,   coin_mult: 1,   price_coins: 0 },
    silver:  { name: "Silver",  icon: "<i class='fa-solid fa-medal' style='color:#C0C0C0'></i>", color: "#C0C0C0", token_bonus: 200,  xp_mult: 1.3, coin_mult: 1.2, price_coins: 500 },
    gold:    { name: "Gold",    icon: "<i class='fa-solid fa-medal' style='color:#FFD700'></i>", color: "#FFD700", token_bonus: 500,  xp_mult: 1.8, coin_mult: 1.5, price_coins: 1500 },
    diamond: { name: "Diamond", icon: "<i class='fa-solid fa-gem' style='color:#00D4FF'></i>", color: "#B9F2FF", token_bonus: 1000, xp_mult: 2.5, coin_mult: 2,   price_coins: 4000 }
};
...
const UD_DATA = {
    beginner: [
        {
            id: 'tb0', emoji: '<i class="fa-solid fa-font" style="color:#60a5fa"></i>', title: 'Türk Alfabesi', desc: "Türk alifbosini o'rganish", level: 'beginner',
        ...
        {
            id: 'tb1', emoji: '<i class="fa-solid fa-hand" style="color:#f5c842"></i>', title: 'Salomlashish', desc: "Salomlashish va xayrlashish", level: 'beginner',
        ...
        {
            id: 'tb2', emoji: '<i class="fa-solid fa-hashtag" style="color:#60a5fa"></i>', title: 'Sayılar', desc: "Raqamlar va hisoblash", level: 'beginner',
        ...
        {
            id: 'tb3', emoji: '<i class="fa-solid fa-palette" style="color:#a78bfa"></i>', title: 'Renkler', desc: "Turk tilida ranglar", level: 'beginner',
        ...
        {
            id: 'tb4', emoji: '<i class="fa-solid fa-people-roof" style="color:#60a5fa"></i>', title: 'Aile', desc: "Oila a'zolari", level: 'beginner',
        ...
        {
            id: 'tb5', emoji: '<i class="fa-solid fa-apple-whole" style="color:#f87171"></i>', title: 'Yemek ve İçecekler', desc: "Ovqat va ichimliklar", level: 'beginner',
    ...
    elementary: [
        {
            id: 'te1', emoji: '<i class="fa-solid fa-house-chimney" style="color:#5b7cfa"></i>', title: 'Ev ve Odalar', desc: "Uy va xonalar", level: 'elementary',
        ...
        {
            id: 'te2', emoji: '<i class="fa-solid fa-briefcase" style="color:#94a3b8"></i>', title: 'Meslekler', desc: "Kasblar", level: 'elementary',
        ...
        {
            id: 'te3', emoji: '<i class="fa-solid fa-cart-shopping" style="color:#5b7cfa"></i>', title: 'Alışveriş', desc: "Xarid qilish", level: 'elementary',
    ...
    'pre-intermediate': [
        {
            id: 'tp1', emoji: '<i class="fa-solid fa-hat-wizard" style="color:#a78bfa"></i>', title: 'Gelecek Planları', desc: "Kelajak zamonlari", level: 'pre-intermediate',
        ...
        {
            id: 'tp2', emoji: '<i class="fa-solid fa-bullseye" style="color:#f87171"></i>', title: 'Geçmiş Zaman', desc: "O\'tgan zamon (-di/-dı)", level: 'pre-intermediate',
    ...
    advanced: [
        {
            id: 'ta1', emoji: '<i class="fa-solid fa-pen" style="color:#60a5fa"></i>', title: 'Akademik Yazı', desc: "Akademik yozuv", level: 'advanced',
        ...
        {
            id: 'ta2', emoji: '<i class="fa-solid fa-clipboard-list" style="color:#94a3b8"></i>', title: 'İleri Türkçe', desc: "Ilg\'or Turkcha", level: 'advanced',
            words: ['ayrıca', 'ancak', 'bu nedenle', 'nüans', 'belagat', 'hafifletmek', 'emsalsiz', 'titiz', 'fırsat', 'her ne kadar'],
            xp: 250, coin: 110,
    ...
    try {
        ...
        users.forEach((u, i) => {
            ...
            html += `<div class="lb-row${isMe ? ' me' : ''}">
                ...
                <div style="flex:1">
                    <div class="lb-name">${esc(u.displayName || u.email || 'Foydalanuvchi')}${isMe ? ' <span style="color:#e05a14;font-size:0.72rem">(siz)</span>' : ''}</div>
    ...
    content.innerHTML = `
      <div style="text-align:center;padding-bottom:20px">
        ...
        <div style="display:flex;gap:16px;justify-content:center;margin:16px 0;flex-wrap:wrap">
          ...
          <span style="color:#e05a14"><i class="fa-solid fa-ticket" style="color:#a78bfa"></i> 2 token/dars</span>
        </div>
      </div>
      ...
      <div>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px">
          ${unit.words.map(w=>`<span onclick="window.spk('${w.replace(/'/g,"\\'")}',event)" style="background:rgba(224,90,20,0.1);border:1px solid rgba(224,90,20,0.2);color:#f09944;padding:4px 10px;border-radius:20px;font-size:0.76rem;cursor:pointer">${w} <i class='fa-solid fa-volume-high' style='color:#5b7cfa'></i></span>`).join('')}
        </div>
      </div>`;
    modal.classList.add('active');
...
function lessonA(unit) {
    ...
    const fills = words.slice(0, 4).map((w, i) => {
        ...
        return `<div style="margin-bottom:14px;padding:14px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
          ...
          <div style="display:flex;gap:6px">
            ...
            <button onclick="window.aiExWord('${w.replace(/'/g,"\\'")}',event)" style="padding:6px 14px;border-radius:8px;background:rgba(224,90,20,0.1);border:1px solid rgba(224,90,20,0.25);color:#f09944;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class='fa-solid fa-robot' style='color:#a78bfa'></i> AI</button>
    ...
    <div style="margin-bottom:20px;padding:16px;background:rgba(224,90,20,0.06);border:1px solid rgba(224,90,20,0.15);border-radius:12px">
      ...
      <div style="font-size:0.9rem;color:#fbd38d;margin-bottom:8px"><i class="fa-solid fa-lightbulb" style="color:#f5c842"></i> ${unit.grammar_rule || ''}</div>
      <div style="font-size:0.85rem;color:#f09944;font-style:italic"><i class="fa-solid fa-pencil" style="color:#60a5fa"></i> ${unit.grammar_example || ''}</div>
    ...
    <button onclick="window.finLessonA('${unit.id}')" style="width:100%;padding:14px;border-radius:12px;background:linear-gradient(135deg,#e05a14,#f09944);border:none;color:#fff;font-size:0.95rem;font-weight:700;cursor:pointer;font-family:inherit"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> Grammatika darsini yakunlash</button>`;
}
...
function lessonB(unit) {
    ...
    <div style="margin-bottom:20px;padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px">
        ...
        <button onclick="window.playDict('${unit.id}','slow')" style="padding:8px 16px;border-radius:8px;background:rgba(224,90,20,0.1);border:1px solid rgba(224,90,20,0.2);color:#f09944;cursor:pointer;font-size:0.82rem;font-family:inherit"><i class="fa-solid fa-gauge-simple" style="color:#94a3b8"></i> Sekin</button>
      </div>
      ...
      <div style="display:flex;gap:6px;margin-top:8px">
        ...
        <button onclick="window.aiChkDict()" style="padding:7px 14px;border-radius:8px;background:rgba(224,90,20,0.1);border:1px solid rgba(224,90,20,0.25);color:#f09944;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-robot" style="color:#a78bfa"></i> AI tahlil (1 token)</button>
      </div>
      <div id="dictFB" style="margin-top:8px;font-size:0.8rem"></div>
    </div>
    <button onclick="window.finLessonB('${unit.id}')" style="width:100%;padding:14px;border-radius:12px;background:linear-gradient(135deg,#22d3ee,#e05a14);border:none;color:#fff;font-size:0.95rem;font-weight:700;cursor:pointer;font-family:inherit"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> Listening yakunlash</button>`;
}
...
function renderLex(exs, idx) {
    ...
    return `<div style="padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px">
        ...
        <button onclick="window.playLex(${idx},'slow')" style="padding:8px 16px;border-radius:8px;background:rgba(224,90,20,0.1);border:1px solid rgba(224,90,20,0.2);color:#f09944;cursor:pointer;font-size:0.82rem;font-family:inherit"><i class="fa-solid fa-gauge-simple" style="color:#94a3b8"></i> Sekin</button>
      </div>
...
function lessonC(unit) {
    ...
    <div style="margin-bottom:20px">
      ...
      <div style="padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
        ...
        <button onclick="window.rdAloud()" style="margin-top:12px;padding:7px 14px;border-radius:8px;background:rgba(96,165,250,0.1);border:1px solid rgba(96,165,250,0.2);color:#60a5fa;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-volume-high" style="color:#5b7cfa"></i> Tinglash</button>
      </div>
    </div>
    <div style="margin-bottom:20px">
...
window.chkWH = function (i) {
    ...
    if(inp.value.trim().toLowerCase()===inp.dataset.ans.toLowerCase()){fb.innerHTML='<i class="fa-solid fa-circle-check" style="color:#34d399"></i>';inp.style.borderColor='#34d399';awardXP(8,'writing');}
...
function lessonD(unit) {
    ...
    <div style="margin-bottom:20px">
      ...
      ${topics.map((w,i)=>{
        ...
        return `<div style="margin-bottom:14px;padding:14px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
          ...
          <div style="display:flex;gap:6px;margin-top:8px">
            <button onclick="window.aiSpk(${i},'${w}')" style="padding:6px 14px;border-radius:8px;background:rgba(224,90,20,0.1);border:1px solid rgba(224,90,20,0.25);color:#f09944;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-robot" style="color:#a78bfa"></i> AI baholash (1 token)</button>
    ...
    <div style="margin-bottom:20px">
      ...
      <div style="padding:14px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px">
        ...
        <div style="display:flex;gap:6px">
          <button onclick="window.aiWrit('${unit.title}','${unit.words.slice(0,5).join(',')}')" style="padding:7px 14px;border-radius:8px;background:rgba(224,90,20,0.1);border:1px solid rgba(224,90,20,0.25);color:#f09944;cursor:pointer;font-size:0.78rem;font-family:inherit"><i class="fa-solid fa-robot" style="color:#a78bfa"></i> AI (1 token)</button>
    ...
    <button onclick="window.finLessonD('${unit.id}')" style="width:100%;padding:14px;border-radius:12px;background:linear-gradient(135deg,#f472b6,#e05a14);border:none;color:#fff;font-size:0.95rem;font-weight:700;cursor:pointer;font-family:inherit"><i class="fa-solid fa-circle-check" style="color:#34d399"></i> Speaking & Writing yakunlash</button>`;
}
...
window.togMic = function (idx) {
    ...
    rec.onerror=e=>{if(btn)btn.innerHTML='<i class="fa-solid fa-microphone" style="color:#f87171"></i> Gapirish';lessonMics[idx]=null;if(e.error==='not-allowed'&&tr)tr.innerHTML=`<textarea style="width:100%;padding:8px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:#e8ecff;font-family:inherit" id="man${idx}" placeholder="Yozing..."></textarea>`;};
    ...
    try{rec.start();lessonMics[idx]=rec;if(btn)btn.innerHTML='⏹ To\'xtatish';if(st)st.innerHTML='<i class="fa-solid fa-circle" style="color:#ef4444"></i> Yozmoqda...';}
...
window.aiSpk = async function (idx, topic) {
    ...
    const r=await callAI(`Speaking baholash. Mavzu: "${topic}" (Turkcha). O'quvchi: "${text}".\n${NATIVE_LANG} tilida (javob shu tilda bo'lsin): 1) <i class="fa-solid fa-circle-check" style="color:#34d399"></i> Yaxshi 2) <i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> Xatolar 3) <i class="fa-solid fa-rotate" style="color:#5b7cfa"></i> Tuzatilgan 4) <i class="fa-solid fa-star" style="color:#f5c842"></i> /10`,700);
    if(fb)fb.innerHTML=esc(r).replace(/\n/g,'<br>');
...
function openWModal(w) {
    ...
    c.innerHTML=`<div style="text-align:center;padding:20px">
      ...
      <div style="display:flex;gap:8px;justify-content:center">
        <button onclick="window.spk('${w.e.replace(/'/g,"\\'")}',event)" style="padding:8px 20px;border-radius:10px;background:rgba(224,90,20,0.15);border:1px solid rgba(224,90,20,0.3);color:#f09944;cursor:pointer;font-family:inherit"><i class='fa-solid fa-volume-high' style='color:#5b7cfa'></i> Talaffuz</button>
        <button onclick="window.aiExWord('${w.e.replace(/'/g,"\\'")}',event)" style="padding:8px 20px;border-radius:10px;background:rgba(240,153,68,0.1);border:1px solid rgba(240,153,68,0.25);color:#f09944;cursor:pointer;font-family:inherit"><i class='fa-solid fa-robot' style='color:#a78bfa'></i> AI (1 token)</button>
      </div>
...
window.checkQuizOpt = function (btn, chosen, type) {
    ...
    else{if(fb)fb.innerHTML=`<span style="color:#ef4444"><i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> To'g'ri: ${type==='tr2uz'?curQuizWord.u:curQuizWord.e}</span>`;}
...
window.checkGrammar = function (chosen, ans, exp) {
    ...
    if(chosen===ans){
        ...
        if(fb)fb.innerHTML=`<div style="color:#ef4444;padding:10px;border-radius:10px;background:rgba(239,68,68,0.1)"><i class="fa-solid fa-circle-xmark" style="color:#f87171"></i> Noto'g'ri. To'g'ri: <b>${ans}</b>. ${exp}</div>`;
    }
};
...
window.clearChatHistory = async function () {
    ...
    if(c) c.innerHTML=`<div class="chat-msg ai-msg"><div class="chat-avatar"><i class="fa-solid fa-robot"></i></div><div class="chat-bubble">Merhaba! Chat tarixi temizlendi. Yeni konuşmaya başlayalım! <i class="fa-solid fa-face-smile" style="color:#f5c842"></i></div></div>`;
