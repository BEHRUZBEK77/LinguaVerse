...
const LV_LANG_CONFIG = {
    uz: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> Til o'zgartirildi! Sahifa yangilanmoqda...",
        }
    },
    en: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> Language changed! Reloading page...",
        }
    },
    ru: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> Язык изменён! Перезагрузка...",
        }
    },
    es: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> ¡Idioma cambiado! Recargando...",
        }
    },
    de: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> Sprache geändert! Wird neu geladen...",
        }
    },
    fr: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> Langue changée! Rechargement...",
        }
    },
    tr: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> Dil değiştirildi! Yeniden yükleniyor...",
        }
    },
    ar: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> تم تغيير اللغة! إعادة تحميل...",
        }
    },
    zh: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> 语言已更改！正在重新加载...",
        }
    },
    ja: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> 言語が変更されました！再読み込み中...",
        }
    },
    ko: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> 언어가 변경되었습니다! 다시 로드합니다...",
        }
    },
    it: {
        ...
        ui: {
            ...
            toast_success: "<i class='fa-solid fa-circle-check' style='color:#34d399'></i> Lingua cambiata! Ricaricamento...",
        }
    }
};
